...
#ifndef ROOMOMENTMORPHFUNCNDCORR
#define ROOMOMENTMORPHFUNCNDCORR
...
class RooMomentMorphFuncNDCorr : public RooAbsReal {
...
public:
   ...
   public:
      ...
      ClassDef(RooMomentMorphFuncNDCorr::Grid2, 1);
   };
...
protected:
   ...
   public:
      ...
      void calculateFractions(const RooMomentMorphFuncNDCorr &self, bool verbose = true) const;
   };

public:
   enum Setting { Linear, SineLinear, NonLinear, NonLinearPosFractions, NonLinearLinFractions };

   RooMomentMorphFuncNDCorr();
   RooMomentMorphFuncNDCorr(const char *name, const char *title, RooAbsReal &_m, const RooArgList &varList,
                        const RooArgList &pdfList, const RooArgList &mrefList, Setting setting);
   RooMomentMorphFuncNDCorr(const char *name, const char *title, const RooArgList &parList, const RooArgList &obsList,
                        const Grid2 &referenceGrid, const Setting &setting);
   RooMomentMorphFuncNDCorr(const RooMomentMorphFuncNDCorr &other, const char *name = nullptr);
   RooMomentMorphFuncNDCorr(const char *name, const char *title, RooAbsReal &_m, const RooArgList &varList,
                        const RooArgList &pdfList, const TVectorD &mrefpoints, Setting setting);
   ~RooMomentMorphFuncNDCorr() override;
   TObject *clone(const char *newname) const override { return new RooMomentMorphFuncNDCorr(*this, newname); }

   void setMode(const Setting &setting) { _setting = setting; }
   /// Setting flag makes this RooMomentMorphFuncNDCorr instance behave like the
   ...
   ///
   /// ```C++
   /// RooMomentMorphFuncNDCorr func{<c'tor args you previously passed to RooMomentMorphFunc>};
   ///
   ...
   /// RooMomentMorphFuncNDCorr already normalizes itself in pdf mode.
...
protected:
   ...
   ClassDefOverride(RooMomentMorphFuncNDCorr, 4);
};
