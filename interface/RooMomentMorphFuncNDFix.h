...
#ifndef ROOMOMENTMORPHFUNCNDFIX
#define ROOMOMENTMORPHFUNCNDFIX
...
class RooMomentMorphFuncNDFix : public RooAbsReal {
...
public:
   ...
   public:
      ...
      ClassDef(RooMomentMorphFuncNDFix::Grid2, 1);
   };
...
protected:
   ...
   public:
      ...
      void calculateFractions(const RooMomentMorphFuncNDFix &self, bool verbose = true) const;
   };
...
public:
   ...
   RooMomentMorphFuncNDFix(const char *name, const char *title, RooAbsReal &_m, const RooArgList &varList,
                        const RooArgList &pdfList, const RooArgList &mrefList, Setting setting);
   RooMomentMorphFuncNDFix(const char *name, const char *title, const RooArgList &parList, const RooArgList &obsList,
                        const Grid2 &referenceGrid, const Setting &setting);
   RooMomentMorphFuncNDFix(const RooMomentMorphFuncNDFix &other, const char *name = nullptr);
   RooMomentMorphFuncNDFix(const char *name, const char *title, RooAbsReal &_m, const RooArgList &varList,
                        const RooArgList &pdfList, const TVectorD &mrefpoints, Setting setting);
   ~RooMomentMorphFuncNDFix() override;
   TObject *clone(const char *newname) const override { return new RooMomentMorphFuncNDFix(*this, newname); }

   void setMode(const Setting &setting) { _setting = setting; }
   /// Setting flag makes this RooMomentMorphFuncNDFix instance behave like the
   ...
   ///
   /// ```C++
   /// RooMomentMorphFuncNDFix func{<c'tor args you previously passed to RooMomentMorphFunc>};
   ///
   ...
   /// RooMomentMorphFuncNDFix already normalizes itself in pdf mode.
...
protected:
   ...
   ClassDefOverride(RooMomentMorphFuncNDFix, 4);
};
